...
if __name__ == "__main__":
    ...
    parser.add_argument('--drone',              default="cf26",     type=DroneModel,    help='Drone model (default: CF2X)', metavar='', choices=DroneModel)
    ...
    if ARGS.drone in [DroneModel.CF2X, DroneModel.CF2P, DroneModel.CF26]:
    ...
    if ARGS.drone == DroneModel.CF26:
        action = {str(i): np.array([0, 0, 0, 0, 0, 0]) for i in range(ARGS.num_drones)}
    else:
