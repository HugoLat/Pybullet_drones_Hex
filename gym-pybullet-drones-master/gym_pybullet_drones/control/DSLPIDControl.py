...
class DSLPIDControl(BaseControl):
    ...
    def __init__(self,
        ...
        if self.DRONE_MODEL != DroneModel.CF2X and self.DRONE_MODEL != DroneModel.CF2P and self.DRONE_MODEL != DroneModel.CF26:
            print("[ERROR] in DSLPIDControl.__init__(), DSLPIDControl requires DroneModel.CF2X, DroneModel.CF2P or DroneModel.CF26")
            exit()
        ...
        if self.DRONE_MODEL == DroneModel.CF2X:
            ...
            self.MIXER_MATRIX = np.array([ [0.5,-np.sqrt(3)/2,-1], [0.5,np.sqrt(3)/2,1], [0,1,-1], [-0.5,np.sqrt(3)/2,1], [-0.5,-np.sqrt(3)/2,-1], [0,-1,1] ])
        self.reset()
